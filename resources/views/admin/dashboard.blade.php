        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card bg-info text-white mb-4">
                    <div class="card-body">Total Post<h1>{{ $post }}</h1>
                    </div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card bg-warning text-dark mb-4">
                    <div class="card-body">Total Users<h1>{{ $user }}</h1>
                    </div>

                    <div class="card-footer d-flex align-items-center justify-content-between">
                        <a class="small text-dark stretched-link" href="{{ url('/admin/users') }}">View Details</a>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card bg-primary text-white mb-4">
                    <div class="card-body">Total Admin<h1>{{ $admin }}</h1>
                    </div>
                    <div class="card-footer d-flex align-items-center justify-content-between">
